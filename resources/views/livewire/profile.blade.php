                ...
                <form wire:submit.prevent="save" action="#" method="POST">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select wire:model="user.sex" class="mb-0 form-select" id="sex"
                            ...
                            @error('user.sex') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-sm-4">
                            <div class="form-group">
                                ...
                                <input wire:model="user.city_municipality" class="form-control" id="city_municipality" type="text"
                                    placeholder="City">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input wire:model="user.zip_code" class="form-control" id="zip_code" type="tel" placeholder="ZIP">
                            </div>
                        </div>
                    </div>
                    <div class="mt-3">
                        <button type="submit" class="mt-2 btn btn-gray-800 animate-up-2">Save All</button>
                    </div>
                </form>
