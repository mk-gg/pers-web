                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            ...
                            <p class="mb-0">Sign in with your account</p>
                                {{-- <p class="mb-0"> Email: <strong>admin@pers.com</strong> Password: 
                        ...
                        <form wire:submit.prevent="login" action="#" class="mt-4" method="POST">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-reddit">Sign in</button>
                            </div>
                        </form>
