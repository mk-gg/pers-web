                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input wire:model="location_type" class="form-control" id="location_type" type="text"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input wire:model="longitude" class="form-control" id="longitude" type="text"
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input wire:model="latitude" class="form-control" id="latitude" type="text"
