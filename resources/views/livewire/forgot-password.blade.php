                        ...
                        <form wire:submit.prevent="recoverPassword" action="#" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input wire:model='email' type="email" class="form-control" id="email" placeholder="juan@pers.com" required autofocus>
                                </div>  
                            ...
                            @endif
                            <div class="d-grid">
                                <button type="submit" class="btn btn-reddit">Recover password</button>
                            </div>
                        </form>
                    </div>
                </div>
