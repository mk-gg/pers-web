      ...
      <li class="nav-item">
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
          ...
          <span>
            ...
            <span class="sidebar-text" style="color: #fb503b;">User related shiz</span> 
          </span>
...
{{--       
      <li class="nav-item">
        <span
          ...
          <span>
            ...
            <span class="sidebar-text">Today's Incident</span>
          </span>
          <span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
        ...
        <div class="multi-level collapse {{ Request::segment(1) == 'bootstrap-tables' ? 'show' : '' }}" role="list"
          id="submenu-apps" aria-expanded="false">
          <ul class="flex-column nav">
      ...
      {{-- ----------------------- --}}
      {{-- ----------------------- --}}
      <li class="nav-item {{ Request::segment(1) == 'operations' ? 'active' : '' }}">
      ...
      {{-- <li class="nav-item">
        <a href="#" target="_blank" class="nav-link d-flex justify-content-between">
          <span>
            ...
            <span class="sidebar-text">Button3</span>
          </span>
          {{--
          <span>
