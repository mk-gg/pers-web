<x-layouts.base>
    ...
    'buttons',
    'forms', 'modals', 'notifications', 'typography', 'upgrade-to-pro', 'new-user', 'new-locations', 'edit-user', 'incidents', 'new-incident', 'locations', 'new-location', 'operations', 'edit-incident']))
